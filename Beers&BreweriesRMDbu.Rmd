...
### After viewing the areas where there is missing data, I have determined to leave the NAs out of some of the information (IBU - ALe comparison, median alcohol) where it doesn't effect the result as much and leave in where it does (such as number of breweries)
